...
import { createApp } from 'vue'; //vue 에서 앱을 만들 수 있는 함수 가져오기
// import App from './App.vue'; // 기본 컴포넌트 사용
// import App from './App2.vue'; // 객체를 이용한 props 전달
// import App from './App5.vue'; //사용자 정의 이벤트를 이용한 정보 전달
import App5_2 from './App5_2.vue'; //이벤트 유효성검증

// //전역 컴포넌트 등록
// import CheckboxItem2 from './Components/CheckboxItem.vue';
// createApp(App).component('CheckboxItem1', CheckboxItem2).mount('#app');

createApp(App5_2).mount('#app');
//App.vue 를 기반으로 Vue 앱을 만들어서
//index.html 에 있는 #app 인 요소에 mount(붙이기)
